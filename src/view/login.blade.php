...
<div class="container-login100">
			<div class="wrap-login100 p-b-160 p-t-50">
                <form class="login100-form validate-form" name="form" action="{{ route('Back.admin.login.web') }}" method="post">
                <input type="hidden" name="_token" value="{{ csrf_token() }}" />
					<span class="login100-form-title p-b-43">
						Account Login
					</span>

					<div class="wrap-input100 rs1 validate-input @error('email') alert-validate @enderror" data-validate="Username is required">
						<input class="input100" type="email" name="email" required>
						<span class="label-input100">Username</span>
					</div>


					<div class="wrap-input100 rs2 validate-input @error('password') alert-validate @enderror" data-validate="Password is required">
						<input class="input100" type="password" name="password" required>
						<span class="label-input100">Password</span>
					</div>
<div class="wrap-inputauto " data-validate="checkbox is required">
						<input class="inputcheckbox" type="checkbox" name="remember">
						<span class="label-inputcheckbox">remember me</span>
					</div>
